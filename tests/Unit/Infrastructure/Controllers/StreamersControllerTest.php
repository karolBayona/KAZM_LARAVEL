...
class StreamersControllerTest extends TestCase
{
     ...
     */
    protected StreamersDataProvider|Mockery\MockInterface $streamersProvider;
    ...
    protected function setUp(): void
    {
        ...
        $this->streamersProvider = Mockery::mock(StreamersDataProvider::class);
        $this->streamersController       = new GetStreamersController($this->streamersProvider);
